...
$message = "<div style='margin-left: 30px;'>
    <p style=\"margin-top: 20px\"><a href= \"profile.php\">&lt;&lt; Back to profile page</a></p>
</div>";
...
if (isset($currentUser))
{
    ...
    <p style=\"margin-top: 20px\">Sorry, no user was specified to edit. <br><br> <a href= \"profile.php\">&lt;&lt; Back to profile page</a></p> </div>";
...
if (isset($_POST['submit']))
{
    ...
    $message = "<div style='margin-left: 457px;'>
    <p style=\"margin-top: 20px\">Your account was successfully edited. <br><br> <a href= \"profile.php\">&lt;&lt; Back to profile page</a> </p></div>";
}
